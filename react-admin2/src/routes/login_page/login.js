...
export function Login(props) {
    ...
    fetch('http://localhost:3000/eventee2/api/ws.php?action=adminLogin', {
        method: 'POST',
        // body: login_details,
        credentials: 'include',
    })
    ...
    return (
        <form method="POST" action="api/ws.php" noValidate>
            ...
            <button className="btn indigo waves-effect waves-light" type="submit" name="login"
                onclick="postLoginFetch()">Login</button>
        </form>
    );
}
